<!---------------------------------------patient_opthalmology _view page starts------------------------------>
...
<td><a href="patient_doc_profile.php?id=<?php echo $row['doctor_id']; ?>" class="btn btn-outline-secondary  btn-arrow-right" role="button">Book Appointment</a></td></td>
</tr>
        <?php 
					  }
                      ?>
...
<!---------------------------------------patient_opthalmology _view page ends------------------------------>